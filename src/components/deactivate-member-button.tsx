...
import { UserX, AlertCircle, X, CheckCircle } from "lucide-react";
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              ...
              <div className="float-up relative w-full max-w-md rounded-2xl border border-line bg-surface p-6 shadow-xl">
                <div className="flex items-center justify-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-bold tracking-tight">Deactivated!</h3>
                    <p className="mt-1 text-sm text-ink-2">
                      {userName} has been deactivated. Reloading...
                    </p>
                  </div>
                </div>
              </div>
