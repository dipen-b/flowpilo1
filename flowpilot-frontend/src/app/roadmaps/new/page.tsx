...
function NewRoadmapContent() {
  ...
  const { addRoadmap } = useRoadmapsStore();
    ...
    <AppLayout>
      <div className="max-w-2xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-secondary-text">Plan your product strategy and releases</p>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <FormField label="Roadmap Name" error={errors.name} required>
                <Input
                  placeholder="e.g., Q3 2026 - Growth Features"
                  value={formData.name}
              ...
              <FormField label="Project" error={errors.project} required>
                <Input
                  placeholder="e.g., FlowPilot Frontend"
