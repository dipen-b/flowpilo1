  ...
  return (
    <AppLayout>
      <div className="max-w-2xl">
        {/* Header */}
        <div className="mb-8">
          <Link href={ROUTES.PROJECT_DETAIL(projectId)} className="flex items-center gap-2 text-primary-text hover:text-purple-400 mb-4">
            <ArrowLeft size={16} />
            Back to Project
          </Link>
          <h1 className="text-3xl font-bold mb-2">Edit Project</h1>
          <p className="text-secondary-text">{project.name}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-3">
            ...
            <Link href={ROUTES.PROJECT_DETAIL(projectId)} className="flex-1">
